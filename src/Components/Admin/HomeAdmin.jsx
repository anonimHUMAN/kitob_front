...
function HomeAdmin() {
    ...
    const getAuthors = async () => {
        let res = await axios.get(`${config.url}/routeadmin/authors`, {
            headers: {
    ...
    const getAuthorBooks = async () => {
        let res = await axios.get(`${config.url}/routeadmin/author/books/${window.localStorage.getItem("idAuthor")}`, {
            headers: {
                authorization: window.localStorage.getItem("token")
            }
        })
    ...
    const getUcers = async () => {
        let res = await axios.get(`${config.url}/routeadmin/ucers`, {
            headers: {
                authorization: window.localStorage.getItem("token")
            }
        })
    ...
    const crAuthor = async () => {
        if (gcv(inp1) && gcv(inp2) && gcv(inp3) && gcv(inp4) && gcv(inp5) && gcv(inp6) && gcv(inp7) && imgInp.current.value) {
            ...
            let res = await axios.post(`${config.url}/routeadmin/crauthor`, data, {
                headers: {
                    authorization: window.localStorage.getItem("token")
                }
            })
    ...
    const delAuthor = async (id) => {
        let res = await axios.delete(`${config.url}/routeadmin/delauthor?idAuthor=${id}`, {
            headers: {
                authorization: window.localStorage.getItem("token")
            }
        })
    ...
    const crBook = async () => {
        if (gcv(inp1) && gcv(inp2) && gcv(inp3) && gcv(inp4) && gcv(inp5) && gcv(inp6) && gcv(inp7) && gcv(inp8) && imgInp.current.value) {
            ...
            let res = await axios.post(`${config.url}/routeadmin/crbook`, data, {
                headers: {
                    authorization: window.localStorage.getItem("token")
                }
            })
    ...
    const addBookToAuthor = async (id) => {
        ...
        let res1 = await axios.post(`${config.url}/routeadmin/addbook`, data, {
            headers: {
                authorization: window.localStorage.getItem("token")
            }
        })
                ...
                <div className="center1">
                    ...
                    <div className="rightSide">
                        ...
                        {create && <div className="cards">
                            ...
                            <div onClick={toggleCreateB} className="card">
                                <i><ion-icon name="book-outline"></ion-icon></i>
                                <h1>Create book</h1>
                            </div>
                        </div>}
